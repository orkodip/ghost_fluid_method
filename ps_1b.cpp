...
void GFM::Poisson(int *C,int *R,double *A,double *b)
{
	...
	double a_j=0.0,b_j=1.0;	//jump conditions
	double TH_l=0.0,TH_r=1.5;	//Dirichlet boundary conditions
